...
public class BenchmarkConstants {
    ...
    public static final String NAME = configParser.get("NAME", String.class);
    public static final String SURNAME = configParser.get("SURNAME", String.class);

    public static final String METHOD_NAME = configParser.get("METHOD_NAME", String.class);
    public static final String INTERFACE_METHOD_NAME = configParser.get("INTERFACE_METHOD_NAME", String.class);
    ...
    public static final boolean SHOULD_FAIL_ON_ERROR = configParser.get("SHOULD_FAIL_ON_ERROR", Boolean.class);
    public static final boolean SHOULD_DO_GC = configParser.get("SHOULD_DO_GC", Boolean.class);
}
